            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
                    ...
                    <div className="space-y-8 text-left relative z-20">
                        <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-shadow-2xs">
                    ...
                    <div className="relative lg:-ml-24 z-10 ">
                        <div className="flex gap-3 mb-4 justify-end">
                            <button className="px-4 py-2 bg-white border-2 border-black rounded-lg text-sm font-medium text-gray-700 hover:border-emerald-500 transition-colors flex items-center gap-2">
                        ...
                        <div className="p-8 border-t-2 border-r-2 border-b-2 border-l-0 border-black border rounded-xl bg-gradient-to-b from-white via-emerald-50/30 to-white">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                            ...
                            <div className="rounded-xl  border-2 border-black shadow-lg p-6 text-left bg-white">
                            ...
                            {/* Card 2 - Dépenses */}
                            <div className="shadow-lg rounded-xl border-2 border-black  p-6 text-left bg-white">
                                <div className="flex justify-between items-start mb-3">
